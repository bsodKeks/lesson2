...
import com.als.l2.R
import com.als.l2.databinding.FragmentContactsBinding
import com.als.l2.model.db.CITY
            ...
            cursorWithContacts?.let { cursor ->
                for (i in 0..cursor.count) {
                    ...
                    if (cursor.moveToPosition(i)) {
                        ...
                        val phoneNum = cursor.getString(cursor.getColumnIndex(ContactsContract.Contacts.HAS_PHONE_NUMBER))
                        addView(it, phoneNum)
